export type BlockType = "hero" | "services" | "faq" | "cta" | "testimonials" | "gallery" | "header" | "footer" | "form" | "about" | "contact" | "whatsapp" | "pricing" | "team" | "features" | "stats" | "portfolio" | "benefits" | "process" | "image" | "video" | "review-form" | "timeline" | "clients";
...
export const BLOCK_TYPES: BlockType[] = [
  ...
  "form", "about", "contact", "whatsapp", "pricing", "team", "features", "stats", "portfolio", "benefits", "process", "image", "video", "review-form", "timeline", "clients",
];
...
export function getBlockDefaultContent(type: BlockType): any {
  const defaults: Record<BlockType, any> = {
    ...
    timeline: { eyebrow: "Nuestra Historia", titleLine1: "El camino que nos ha", titleHighlight: "traído aquí.", items: [{ year: "2019", icon: "bi-lightbulb", title: "El inicio", desc: "Nacemos..." }] },    clients: { title: "Formación de calidad", items: [{ image: "https://placehold.co/200x80/ffffff/6b7280?text=Logo", alt: "Cliente 1" }] },
