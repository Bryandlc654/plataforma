        ...
        <div class="container-x relative pt-56 pb-24 md:pt-64 md:pb-32 min-h-screen flex flex-col justify-center">
            <div class="max-w-3xl animate-fade-up">
                ...
                <div class="mt-10 flex flex-wrap gap-4">
                    ...
                    ${c.secondaryButtonText ? `<a href="${siteHref(c.secondaryButtonUrl || '#')}" class="inline-flex items-center gap-2 rounded-full glass text-white px-7 py-4 text-base font-semibold hover:bg-white/25 transition-all">
