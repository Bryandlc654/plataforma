        ...
        <div className="fixed inset-0 z-50 flex items-start justify-center pt-20" onClick={()=>setShowSettings(false)}>
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md max-h-[75vh] overflow-y-auto m-4 z-10" onClick={e=>e.stopPropagation()}>
            ...
            <div className="p-4 space-y-3">
              ...
              <div className="rounded-lg bg-slate-50 border border-slate-200 p-3"><p className="text-xs font-medium text-slate-700 mb-0.5">SEO del sitio</p><p className="text-xs text-slate-500 mb-2">Los metadatos, títulos y OpenGraph se gestionan desde el módulo SEO.</p><a href="/dashboard/seo" onClick={()=>{saveSiteSettings();setShowSettings(false)}} className="inline-flex items-center gap-1 text-xs font-semibold text-primary-600 hover:text-primary-700"><HiOutlineCog className="h-3.5 w-3.5" />Ir al módulo SEO</a></div>
